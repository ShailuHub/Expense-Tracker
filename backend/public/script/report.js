...
// const mainTable1 = document.getElementById("main-table1");
// const mainTable2 = document.getElementById("main-table2");

// form1.addEventListener("submit", postDate);
// form2.addEventListener("submit", postDate);
...
//     detail.date = dayDate.value;
//     detail.searchType = "date";
//     searchType = "date";
//   } else if (event.target.id === "form2") {
//     detail.month = monthDate.value;
//     detail.searchType = "month";
//     searchType = "month";
//   }
//   try {
...
//       searchDate = await response.data.date;
//     } else if (response.data.month) {
//       searchDate = searchDate = await response.data.month;
//     }
//     await getExpense();
//   } catch (error) {
//     console.log(error);
...
//       response.data.expenseArray.forEach((expense) => {
//         display(expense);
//       });
//       const listItem = document.createElement("tr");
//       listItem.style.borderTop = "none";
//       listItem.style.borderBottom = "none";
//       listItem.innerHTML = `<td class="col-4 text-center ">Total: ${response.data.totalSum}</td>`;
...
//   const listItem = document.createElement("tr");
//   listItem.innerHTML = `
//       <td class="col-4 text-center">${data.createdAt
//         .toString()
//         .slice(0, 10)}</td>
